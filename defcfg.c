...
char *def_cfg[DEF_CFG_LINES] = {
	...
	"double4                  none",
	"double5                  none",
	"root_button4             next_desktop",
	"root_button5             prev_desktop",
	"mouse_modifier           mod4",
	"no_snap_modifier         shift",
	"ignore_modifier          mod2 lock",
	"key                      mod4 Tab                next",
	"key                      mod4 shift Tab          prev",
	...
	"key                      control mod1 k          to_border tl",
	"key                      control mod1 l          to_border tr",
	"key                      control mod1 n          to_border bl",
	"key                      control mod1 m          to_border br",
	...
	"key                      mod4 Return     exec urxvt",
	"key                      mod4 w		     exec gmrun",
	"key                      mod4 c		     exec rofi -show drun",
	"key                      mod4 b		     exec rofi -show run",
	"key                      mod4 s                  iconify",
	"key                      mod4 x                  maximize",
	...
	"key                      mod4 d                  sticky",
	"key                      mod4 t                  title",
	"key                      mod4 k                  to_border tl",
	"key                      mod4 l                  to_border tr",
	"key                      mod4 n                  to_border bl",
	"key                      mod4 m                  to_border br",
	"key                      mod4 o                  ontop",
	"key                      mod4 p                  below",
